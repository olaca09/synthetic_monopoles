...
%
  \begin{textblock}{15}(0.5,3.3)
   ...
   \end{beamercolorbox}
   Magnetism is inherently dual. Any size of ''magnet'' must have at least two poles, much like a common bar
   ...
   magnets. 
   Other things in nature \textit{appear} to be monopoles even though they are not in the sense of (Maxwellian) electromagnetism, and it
   is this kind of monopole which is studied here.
   This project concerns the modelling and simulation of a certain system, with 
