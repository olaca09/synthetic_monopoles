...
\begin{figure}[h]
        ...
        \begin{tikzpicture}[decoration={markings, mark= between positions 0.1 and 1 step
            ...
            \dgrid[red, dotted, canvas is xy plane at z=5](1,1)(4)(4)(8);
            \dgrid[red, dotted, canvas is yz plane at x=1](1,1)(4)(4)(8);
            \draw[blue] (3,3,3) node[circle, fill, inner sep=3pt]{}; %Zerofield marker
            \dgrid[red, dotted, canvas is yz plane at x=5](1,1)(4)(4)(8);
            \dgrid[red, dotted, canvas is zx plane at y=1](1,1)(4)(4)(8);
            \dgrid[red, dotted, canvas is zx plane at y=5](1,1)(4)(4)(8);
        \end{tikzpicture}
