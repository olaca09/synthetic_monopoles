...
\lstinputlisting[language=Python]{../scripts/magfield.py}

\subsection{synfieldtools.py}
\lstinputlisting[language=Python]{../scripts/synfieldtools.py}

\subsection{synfieldsolver.py}
\lstinputlisting[language=Python]{../scripts/synfieldsolver.py}
