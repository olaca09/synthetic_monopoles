...
if __name__ == '__main__':
    ...
    I = 1 #Current parameter for the field
    ...
    J = 1e12 #Spin-spin coupling strength
    Gamma = 1e12 #Spin-field coupling strength
    ...
    swarmgrid = np.mgrid[0:lablength-20*step:4j,0:lablength-20*step:4j] #Grid to swarm the initial positions
